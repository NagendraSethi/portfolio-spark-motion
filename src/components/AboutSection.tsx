            ...
            <AnimatedElement animation="slide-in-left" className="md:col-span-7 space-y-6">
              ...
              <div className="pt-4">
                <Button size="lg" className="flex items-center" asChild>
                  <a href="NagendraSethi/portfolio-spark-motion/public/Nagendra_NIT_surat_CV.pdf" target="_blank" rel="noopener noreferrer" download="NagendraSethi/portfolio-spark-motion/public/Nagendra_NIT_surat_CV.pdf">
